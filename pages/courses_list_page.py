...
class CoursesListPage(BasePage):
    ...
    def check_visible_course_card(
        ...
        expect(self.self.course_image.nth(index)).to_be_visible()
        ...
        expect(self.self.course_estimated_time_text).to_be_visible()
        expect(self.self.course_estimated_time_text).to_have_text(f"Estimated time: {time}")
