...
class LoginPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.pasword_input = page.get_by_test_id('login-form-password-input').locator("input")
        self.login_button = page.get_by_test_id('login-page-login-button')
        self.registration_link = page.get_by_test_id('login-form-registration-link')
    ...
    def fill_login_form(self, email: str, password: str):
        ...
        self.pasword_input.fill(password)
        expect(self.pasword_input).to_have_value(password)
