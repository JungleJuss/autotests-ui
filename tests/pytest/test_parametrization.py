...
@pytest.mark.parametrize('os', ["macos", "windows", "linus", "ubuntu"])
@pytest.mark.parametrize("browser", ["chrome", "firefox", "webkit"])
def test_multicaplication_of_browser(os: str, browser: str):
...
class TestOperations:
    ...
    def test_user_with_opertations(self, user: str, account: str):
